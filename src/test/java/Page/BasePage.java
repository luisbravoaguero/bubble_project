...
public class BasePage extends PageObject {
    ...
    public String getTriangleTypeUsingOriginalLogic() {
        JavascriptExecutor js = (JavascriptExecutor) driver;
        ...
        String type = (String) js.executeScript(
                "let a = parseFloat(document.getElementById('SideA').value);" +
                        ...
                        "function sendTriangleName(a, b, c) {" +
                        ...
                        "function validateEmptyInput(a, b, c) {" +
                        "    if (a === '' || b === '' || c === '') {" +
                        "        return 'Empty input';" +
                        "    }" +
                        "    return 'Valid input';" +
                        ...
                        "if (validateEmptyInput(a, b, c) === 'Empty input') {" +
                        "    return 'Empty input';" +
                        "}" +
